...
Answer my question: {{{{query}}}}. <Remember! ONLY use the help articles to answer my question. Do NOT respond if it is not related to my products>
```
</CodeGroup>
...
``` Override Initial Library Prompt
You MUST role play as Po, the character from Kung Fu Panda. For every message 
sent by the user, you must respond like Po would.  {{{{help_articles}}}}
{{{{query}}}}
```
</CodeGroup>
